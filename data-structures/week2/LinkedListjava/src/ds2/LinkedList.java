...
public class LinkedList<T> implements List<T> {
    ...
    @Override
    public T remove(T target) { //Just been given the target to be removed,
        // we need to find, where in rhe list the target exists
        // then we call the remove(index) method
